...
begin
  ...
  -- Recebimento lançado diretamente em uma obra fica restrito a ela.
  -- Recebimento geral do cliente permanece com obra_id nulo e pode ser
  -- distribuído entre várias obras por meio das alocações.
