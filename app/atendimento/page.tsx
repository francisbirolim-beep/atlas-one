   ...
   <div className="grid min-h-[680px] lg:grid-cols-[310px_1fr_350px]">
    ...
    <section className="flex min-w-0 flex-col bg-[#f6f3ee]">
     <div className="flex items-center justify-between gap-3 border-b bg-white p-4">
      ...
      <select value={status} onChange={e=>setStatus(e.target.value)} className="rounded-xl bg-blue-600 px-3 py-2 text-sm font-bold text-white"><option>Em atendimento</option><option>Aguardando cliente</option><option>Transferido</option><option>Finalizado</option></select>
     </div>
