  ...
  return <section className="bg-white rounded-2xl border border-slate-200 p-6 space-y-5">
    ...
    {(itens.length>0)&&<div className="space-y-3">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div><h3 className="text-sm font-semibold text-slate-800">Produtos encontrados</h3><p className="text-xs text-slate-500">Confira código, desenho técnico e vínculo antes de usar novos cadastros no Atlas.</p></div>
